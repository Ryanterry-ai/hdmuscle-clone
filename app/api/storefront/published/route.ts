...
const cmsData = {
  ...
  homepage: {
    hero: {
      ...
      subheading: "Premium supplements designed for athletes who demand more. Scientifically formulated to help you reach your peak performance.",
    ...
    faq: {
      ...
      questions: [
        { question: "How long does shipping take?", answer: "Free shipping on orders over $99. Standard shipping takes 3-5 business days." },
  ...
  products: [
    { 
      ...
      badge: "Best Seller", is_active: true, inventory: 100,
      category: "proteins", tags: ["protein", "whey", "muscle-building"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "pre-workouts", tags: ["pre-workout", "energy"]
    },
    { 
      ...
      badge: "New", is_active: true, inventory: 100,
      category: "pre-workouts", tags: ["pre-workout", "pump"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "electrolytes", tags: ["electrolytes", "hydration"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 0,
      category: "pre-workouts", tags: ["pre-workout", "stimulant"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "intra-workouts", tags: ["intra-workout", "endurance"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "health-wellness", tags: ["sleep", "recovery"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "health-wellness", tags: ["greens", "superfood"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "fat-burners", tags: ["fat-burner", "thermogenic"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "creatine", tags: ["creatine", "strength"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "health-wellness", tags: ["multivitamin", "daily"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "recovery", tags: ["glutamine", "recovery"]
    },
    { 
      ...
      badge: "New", is_active: true, inventory: 100,
      category: "pre-workouts", tags: ["pre-workout", "elite"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "bcaas", tags: ["eaa", "amino acids"]
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "health-wellness", tags: ["collagen", "joints"]
    },
    { 
      ...
      badge: "New", is_active: true, inventory: 100,
      category: "apparel", tags: ["hoodie", "apparel"], is_apparel: true
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "apparel", tags: ["hat", "apparel"], is_apparel: true
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "apparel", tags: ["jersey", "apparel"], is_apparel: true
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "apparel", tags: ["tee", "apparel"], is_apparel: true
    },
    { 
      ...
      badge: null, is_active: true, inventory: 100,
      category: "accessories", tags: ["shaker", "accessories"], is_apparel: true
    }
  ],
