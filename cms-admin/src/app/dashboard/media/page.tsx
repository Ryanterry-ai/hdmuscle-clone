...
import { PlusIcon, SearchIcon, TrashIcon, EyeIcon, XIcon, ClipboardCopyIcon } from '@heroicons/react/outline';
...
export default function MediaPage() {
  ...
  const handleImportFromUrl = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        alert('Failed to import media URL');
        return;
      }
  ...
  const handleCopyUrl = async (url: string) => {
    try {
      ...
      alert('Media URL copied. You can paste it into product, collection, page, homepage, or logo fields.');
    } catch (error) {
          ...
          <div className="p-4 border-b border-white/5">
            <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button onClick={handleImportFromUrl} loading={importingUrl}>
                  Import URL
                </Button>
              </div>
            </div>
                ...
                <div key={file.id} className="group relative bg-white/[0.02] rounded-xl border border-white/5 overflow-hidden hover:border-purple-500/50 transition-all">
                  ...
                  <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                    <button
                      ...
                      className="p-1.5 bg-slate-800 rounded-lg hover:bg-slate-700"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 bg-slate-800 rounded-lg hover:bg-red-500/20"
                    >
