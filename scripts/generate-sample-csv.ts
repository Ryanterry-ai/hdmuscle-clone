...
const PRODUCTS = [
  {
    ...
    faq: 'Q: When should I take it? A: Post-workout or between meals. Q: Can I take it with milk? A: Yes, mix with water or milk as preferred.',
  ...
  },
  {
    ...
    faq: 'Q: How much caffeine does it contain? A: 200mg per serving. Q: Can beginners use it? A: Start with half a scoop to assess tolerance.',
  ...
  },
  {
    ...
    faq: 'Q: Do I need a loading phase? A: No, 5g daily is sufficient. Q: Can I stack it with protein? A: Yes, it pairs well with any protein supplement.',
...
const output = stringify(PRODUCTS, { header: true, columns: COLUMNS });
writeFileSync(resolve(__dirname, '..', 'sample_product_data.csv'), output, 'utf-8');
console.log('sample_product_data.csv created');
