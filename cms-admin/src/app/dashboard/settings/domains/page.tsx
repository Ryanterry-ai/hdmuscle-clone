  ...
  return (
    <div className="space-y-6">
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="https://hdmuscle.in"
            />
            <p className="text-xs text-slate-400 mt-1">The public storefront URL (e.g., https://hdmuscle.in)</p>
          </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        ...
        <p className="text-sm text-slate-600 mb-4">To use your custom domain, configure these DNS records at your registrar:</p>
        
        <div className="bg-slate-50 rounded-lg p-4">
          <div className="grid grid-cols-3 gap-4 text-sm border-b border-slate-200 pb-3 mb-3">
            <div>
            ...
            <div>
              ...
              <p className="font-mono text-slate-900">A</p>
            </div>
            <div>
              <p className="text-slate-500">Value</p>
              <p className="font-mono text-slate-900">76.76.21.21</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 text-sm">
            <div>
              <p className="text-slate-500">Host</p>
              <p className="font-mono text-slate-900">www / cms / store</p>
            </div>
            <div>
              <p className="text-slate-500">Type</p>
