    ...
    panel: {
      ...
      columns: [
        ...
        },
        {
          ...
          links: [
            { label: 'CarbHD', href: '/products/carbhd' },
            { label: 'CreaHD (Creapure\u00ae)', href: '/products/creahd' },
            { label: 'EaaHD', href: '/products/eaahd' },
        ...
        },
        {
          ...
          links: [
            { label: 'Betaine HCL', href: '/products/betainehcl' },
            { label: 'BurnHD', href: '/products/burnhd' },
            { label: 'Citrus Bergamot', href: '/products/citrus-bergamot' },
            { label: 'Curcumin', href: '/products/curcumin' },
            { label: 'CollagenHD', href: '/products/collagenhd' },
            { label: 'CreaHD (Creapure\u00ae)', href: '/products/creahd' },
            { label: 'D3', href: '/products/d3' },
            { label: 'EaaHD', href: '/products/eaahd' },
            { label: 'GreensHD', href: '/products/greenshd' },
            { label: 'GlycoHD', href: '/products/glycohd' },
            { label: 'GlutaHD', href: '/products/glutahd' },
            { label: 'K2', href: '/products/k2' },
            { label: 'KidneyHD', href: '/products/kidneyhd' },
            { label: 'LiverHD', href: '/products/liverhd' },
            { label: 'MultiHD', href: '/products/multihd' },
            { label: 'Magnesium', href: '/products/magnesium' },
            { label: 'Omega3', href: '/products/omega3' },
            { label: 'SleepHD', href: '/products/sleephd' },
            { label: 'VitaHD', href: '/products/vitahd' },
